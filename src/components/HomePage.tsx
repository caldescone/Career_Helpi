      ...
      <div className="row mt-5">
        ...
        <div className="columnCenter mt-5">
          <div className="Quiz-Description">
            ...
            you. Access the quiz from the menu above!
            <br></br>
            <br></br>
        ...
        <div className="columnCenter mt-5">
          <div className="Quiz-Description">
            ...
            paths might interest you. Access the quiz from the menu above!
            <br></br>
            <br></br>
        ...
        <div className="Statement">
          <h4>
            A detailed report will be generated using ChatGPT and will be
            provided to you after you complete the quiz.
          </h4>
        </div>
      </div>
    </div>
